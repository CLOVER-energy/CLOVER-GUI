...
class GHGFrame(ttk.Frame):
    ...
    def __init__(self, parent):
        ...
        self.bos_decrease_entry = ttk.Entry(
            self, bootstyle=DANGER, textvariable=self.bos_decrease
        )
        ...
        self.initial_grid_label.grid(row=8, column=1, sticky="w")
