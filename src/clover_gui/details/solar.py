...
class PVFrame(_BaseSolarFrame):
    ...
    def __init__(
        ...
        self.pv_panel_label = ttk.Label(
            self.scrolled_frame,
            text="Panel to configure",
        )
        ...
        # Panel name
        self.panel_name_label = ttk.Label(
            self.scrolled_frame,
            text="Panel name",
        )
        ...
        # Nominal power
        self.nominal_power_label = ttk.Label(
            self.scrolled_frame,
            text="Nominal power",
        )
...
class SolarThermalFrame(_BaseSolarFrame):
    ...
    def __init__(
        ...
        self.collector_name_values = {
            ...
            (collector_name := "PTC"): ttk.StringVar(self, collector_name),
        }
