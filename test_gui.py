    ...
    def __init__(self, master):
        ...
        solar_images: dict[bool, tkinter.PhotoImage] = {
            True: tkinter.PhotoImage(
                file=os.path.join("images", "solar_gui_selected.png")
            ),
        ...
        diesel_images: dict[bool, tkinter.PhotoImage] = {
            True: tkinter.PhotoImage(
                file=os.path.join("images", "diesel_gui_selected.png")
            ),
            False: tkinter.PhotoImage(
                file=os.path.join("images", "diesel_gui_deselected.png")
            ),
        }
        ...
        grid_images: dict[bool, tkinter.PhotoImage] = {
            True: tkinter.PhotoImage(
                file=os.path.join("images", "grid_gui_selected.png")
            ),
            False: tkinter.PhotoImage(
                file=os.path.join("images", "grid_gui_deselected.png")
            ),
        }
        ...
        domestic_images: dict[bool, tkinter.PhotoImage] = {
            True: tkinter.PhotoImage(
                file=os.path.join("images", "domestic_gui_selected.png")
            ),
            False: tkinter.PhotoImage(
                file=os.path.join("images", "domestic_gui_deselected.png")
            ),
        }
        ...
        commercial_images: dict[bool, tkinter.PhotoImage] = {
            True: tkinter.PhotoImage(
                file=os.path.join("images", "commercial_gui_selected.png")
            ),
            False: tkinter.PhotoImage(
                file=os.path.join("images", "commercial_gui_deselected.png")
            ),
        }
        ...
        public_images: dict[bool, tkinter.PhotoImage] = {
            True: tkinter.PhotoImage(
                file=os.path.join("images", "public_gui_selected.png")
            ),
            False: tkinter.PhotoImage(
                file=os.path.join("images", "public_gui_deselected.png")
            ),
        }
